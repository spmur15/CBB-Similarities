...
def nav_label(mobile_top, mobile_bottom=None, desktop=None):
    return html.Span([
        ...
        html.Span(
            ...
            className="d-inline d-md-none text-center",
...
def browse_layout():
    return html.Div([
        ...
        html.P(
            ...
            "This analysis may take ~10–15 seconds to run.",
...
def update_player_results(player_name):
    if not player_name:
        return html.Div("Select a player to see similar teams.")
...
def update_team_results(team_name, pos_class):
    if not team_name or not pos_class:
        return html.Div("Select a team and position to see similar players.")
